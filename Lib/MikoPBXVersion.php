...
class MikoPBXVersion
{
    ...
    /**
     * Return Security class for the current version of PBX
     *
     * @return class-string<\Phalcon\Encryption\Security>|class-string<\Phalcon\Security>
     */
    public static function getSecurityClass(): string
    {
        if (self::isPhalcon5Version()) {
            return  \Phalcon\Encryption\Security::class;
        } else {
            return  \Phalcon\Security::class;
        }
    }
}
