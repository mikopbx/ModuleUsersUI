 ...
 *
 */
const idUrl     = 'module-usersui';
const idForm    = 'module-usersui-form';
const className = 'ModuleUsersUI';
		...
		switch (status) {
			...
			case 'Updating':
				window[className].$moduleStatus
					...
					.removeClass('red')
					.addClass('grey');
				window[className].$moduleStatus.html(`<i class="spinner loading icon"></i>${globalTranslate.module_usersuiUpdateStatus}`);
				break;
			default:
				window[className].$moduleStatus
					.removeClass('green')
