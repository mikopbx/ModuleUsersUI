...
return [
    ...
    'BreadcrumbUserProfile' => 'Мой профиль',
    'SubHeaderUserProfile' => 'Смена пароля и управление ключами доступа',
    ...
    'module_usersui_CheckBox_AdminCabinet_AsteriskManagers_save' => 'редактирование и удаление',
    ...
    'module_usersui_CheckBox_AdminCabinet_CallQueues_save' => 'редактирование и удаление',
    ...
    'module_usersui_CheckBox_AdminCabinet_ConferenceRooms_save' => 'редактирование и удаление',
    ...
    'module_usersui_CheckBox_AdminCabinet_DialplanApplications_save' => 'редактирование и удаление',
    ...
    'module_usersui_CheckBox_AdminCabinet_Extensions_save' => 'редактирование и удаление',
    'module_usersui_CheckBox_AdminCabinet_Extensions_bulkupload' => 'массовая загрузка сотрудников',
    ...
    'module_usersui_CheckBox_AdminCabinet_IncomingRoutes_save' => 'редактирование и удаление',
    ...
    'module_usersui_CheckBox_AdminCabinet_IvrMenu_save' => 'редактирование и удаление',
    'module_usersui_CheckBox_AdminCabinet_OffWorkTimes_index' => 'доступ к разделу',
    'module_usersui_CheckBox_AdminCabinet_OffWorkTimes_modify' => 'открыть детали',
    'module_usersui_CheckBox_AdminCabinet_OffWorkTimes_save' => 'редактирование и удаление',
    ...
    'module_usersui_CheckBox_AdminCabinet_OutboundRoutes_save' => 'редактирование и удаление',
    ...
    'module_usersui_CheckBox_AdminCabinet_Providers_save' => 'редактирование и удаление',
    ...
    'module_usersui_CheckBox_AdminCabinet_SoundFiles_save' => 'редактирование и удаление',
    'module_usersui_CheckBox_AdminCabinet_ApiKeys_index'=> 'доступ к разделу',
    'module_usersui_CheckBox_AdminCabinet_ApiKeys_modify'=> 'просмотр данных о ключе и правах',
    'module_usersui_CheckBox_AdminCabinet_ApiKeys_save'=> 'редактирование и удаление',
    'module_usersui_AppTypeREST' => 'Доступ к REST API',
    'module_usersui_AppTypeAPP' => 'Доступ к разделам интерфейса',
    'module_usersui_GenericActionAll' => 'все действия',
    'module_usersui_GenericActionIndex' => 'доступ к разделу',
    'module_usersui_GenericActionSave' => 'сохранение настроек',
    'module_usersui_GenericActionSaveModel' => 'выбор модели',
    'module_usersui_GenericActionAddCustomModel' => 'добавление пользовательской модели',
    'module_usersui_GenericActionDeleteCustomModel' => 'удаление пользовательской модели',
    'module_usersui_GenericActionRetryErrors' => 'повторная обработка ошибок',
    'module_usersui_GenericActionGenerateWorkerApiKey' => 'создание API-ключа обработчика',
    'module_usersui_GenericActionDeleteWorkerApiKey' => 'удаление API-ключа обработчика',
    'module_usersui_GenericActionTranscripts' => 'просмотр списка расшифровок',
    'module_usersui_GenericActionTranscript' => 'просмотр расшифровки',
    'module_usersui_GenericActionRecording' => 'прослушивание записи',
    'module_usersui_GenericActionLogs' => 'просмотр журнала',
    ...
    // User Profile page
    'module_usersui_MyProfile' => 'Мой профиль',
    'module_usersui_ChangePassword' => 'Изменить пароль',
    'module_usersui_CurrentPassword' => 'Текущий пароль',
    'module_usersui_NewPassword' => 'Новый пароль',
    'module_usersui_NewPasswordRepeat' => 'Повторите новый пароль',
    'module_usersui_PasswordManagedByLDAP' => 'Ваш пароль управляется администратором LDAP',
    'module_usersui_PasswordFieldsRequired' => 'Все поля пароля обязательны для заполнения',
    'module_usersui_PasswordsDontMatch' => 'Новые пароли не совпадают',
    ...
    'module_usersui_tt_serverName_header' => 'Варианты транспорта',
    'module_usersui_tt_serverName_plain' => 'незашифрованный LDAP, порт 389.',
    'module_usersui_tt_serverName_starttls' => 'LDAP на 389 порту с переходом в TLS.',
    'module_usersui_tt_serverName_ldaps' => 'LDAP поверх TLS с первого байта, порт 636.',
    'module_usersui_tt_baseDN_header' => 'Корень поиска (Base DN)',
    'module_usersui_tt_baseDN_desc' => 'Корень дерева поиска. При авторизации пользователь ищется внутри него; всё, что выше, не видно.',
    'module_usersui_tt_baseDN_examplesHeader' => 'Примеры',
    'module_usersui_tt_adminLogin_header' => 'Формат логина для bind',
    'module_usersui_tt_adminLogin_desc' => 'Active Directory принимает для bind любой из форматов:',
    'module_usersui_tt_adminLogin_note' => 'LDAPS-прокси в DMZ часто отвечают «Invalid DN syntax» на короткие формы — используйте полный DN.',
    'module_usersui_tt_verify_header' => 'Проверка сертификата',
    'module_usersui_tt_verify_desc' => 'Когда включено, самоподписанные, просроченные и не подписанные указанным CA сертификаты отклоняются. Сам CA указывается на вкладке «Сертификат».',
    'module_usersui_tt_verify_warning_header' => 'Небезопасно без CA',
    'module_usersui_tt_verify_warning' => 'При выключенной проверке соединение всё ещё шифруется, но любой с доступом к сети может выдать себя за LDAP-сервер.',
    'module_usersui_tt_userIdAttr_header' => 'Атрибут логина',
    'module_usersui_tt_userIdAttr_desc' => 'Атрибут LDAP, в котором лежит то, что пользователь вводит в форме входа. Имя зависит от типа сервера:',
    'module_usersui_tt_orgUnit_header' => 'Подразделение (OU)',
    'module_usersui_tt_orgUnit_desc' => 'Необязательно. Ограничивает поиск пользователя этим поддеревом. Оставьте пустым, чтобы искать во всём Base DN.',
    'module_usersui_tt_orgUnit_examplesHeader' => 'Примеры',
    'module_usersui_tt_orgUnit_note' => 'Если задано — войти смогут только пользователи из этого OU.',
    'module_usersui_tt_userFilter_header' => 'Фильтр пользователей',
    'module_usersui_tt_userFilter_desc' => 'Стандартный LDAP-фильтр поверх ограничения по OU. Удобно ограничить вход группой безопасности или классом объекта.',
    'module_usersui_tt_userFilter_examplesHeader' => 'Примеры',
    'module_usersui_tt_userFilter_note' => 'Фильтр соединяется с проверкой логина через AND.',
];
